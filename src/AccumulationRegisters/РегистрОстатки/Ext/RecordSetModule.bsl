...
Процедура ПриЗаписи(Отказ, Замещение)
	...
	Если ЭтотОбъект.ОбменДанными.Загрузка ИЛИ НЕ ПроведениеСерверПТБ.РассчитыватьИзменения(ЭтотОбъект.ДополнительныеСвойства) Тогда
		Возврат;
	КонецЕсли;
	...
	ЭтотОбъект.ДополнительныеСвойства.Вставить("ПравилаПроверкиРесурсов", ПравилаПроверки);
