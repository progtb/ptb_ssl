...
Процедура ОбработкаВыбораТабличнойЧасти(Форма, ВыбранноеЗначение, СтандартнаяОбработка, ВызыватьОбратку = Истина) Экспорт
	...
	КоллекцияДанныхФормы = ГрупповоеРедактированиеТабличныхЧастейКлиентСервер.ПолучитьКоллекциюДанныхФормыПоПутиКДанным(Форма, ВыбранноеЗначение.ПутьКДаннымТекущейТаблицы); 
