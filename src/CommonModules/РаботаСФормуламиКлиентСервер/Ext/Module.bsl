...
//		ТочностьОкругления - Неопределено, Число - точность округления при расчете показателей
//
// Возвращаемое значение:
//   Структура
...
Процедура ДобавитьГруппуПоказателей(знач МассивГрупп, знач ИмяГруппы, знач ОписаниеГруппы) Экспорт
...
Процедура ДобавитьПоказательВГруппу(знач Группа, знач Показатель, знач Описание) Экспорт
	СтруктураПоказателя = Новый Структура("Тип,Показатель,Описание",
		"Показатель",
		Показатель,
		Описание);
		
	Группа.Элементы.Добавить(СтруктураПоказателя);
КонецПроцедуры
