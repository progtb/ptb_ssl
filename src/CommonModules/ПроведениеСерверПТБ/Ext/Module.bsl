...
//
Функция ПодготовитьНаборыЗаписейКРегистрацииДвижений(ДокументОбъект, Отказ)  Экспорт
...
Процедура УдалитьДвиженияРегистратора(ДокументОбъект, Отказ) Экспорт
	...
	ИсключаемыеРегистры = ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(ДокументОбъект.ДополнительныеСвойства, "ИсключаемыеРегистры", Новый Массив);
	...
	ЭтоНовыйДокумент = ДокументОбъект.ДополнительныеСвойства.ЭтоНовый;
	
	Если НЕ ЭтоНовыйДокумент Тогда
		МетаданныеДвижения = ДокументОбъект.Метаданные().Движения;
