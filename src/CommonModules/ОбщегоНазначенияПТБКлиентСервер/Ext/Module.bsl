...
// 14.05.2022, Анисков А.А.
//	+ ДополнитьМассивИзЗначения
//	+ ДополнитьКоллекцию
//	+ ДополнитьСтруктуру
//	+ УстановитьСвойствоСтруктуры
//	+ СвойствоСтруктуры
//	+ НомерКартинкиПоТипуДанных
//	+ ЕстьРеквизитИлиСвойствоОбъекта
//	+ СформироватьПредставлениеПоСтруктуре
...
// Не проверяет ссылки, для них возвращается неопределено
//
// Параметры:
//	ТипЗначения - Тип
//
