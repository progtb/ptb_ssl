...
//
//Заполнение реквизита "_Служебный_ОписаниеТаблицДляГрупповогоРедактирования_" (см. ГрупповоеРедактированиеТабличныхЧастейКлиентСервер.ИмяРеквизитаОписанияТаблицФормы()) 
...
//
Процедура СоздатьРеквизитХраненияОписанияТаблицФормы(Форма, ИмяРеквизитаОписанияТаблицФормы)
...
// 		и сохраняет в реквизит формы "_Служебный_ОписаниеТаблицДляГрупповогоРедактирования_"(см. ГрупповоеРедактированиеТабличныхЧастейКлиентСервер.ИмяРеквизитаОписанияТаблицФормы()). 
//
...
Процедура СформироватьОписаниеТабличныхЧастейФормы(Форма, ИсключаемыеТаблицы = "", ИсключаемыеКолонки = "", ДобавлятьКнопкиВКоманднуюПанельТаблицыФормы = Истина, ОтображениеСуммыВыделенныхСтрок = Неопределено)  Экспорт
	...
	ИмяРеквизитаОписанияТаблицФормы = ГрупповоеРедактированиеТабличныхЧастейКлиентСервер.ИмяРеквизитаОписанияТаблицФормы();
	
 	СоздатьРеквизитХраненияОписанияТаблицФормы(Форма, ИмяРеквизитаОписанияТаблицФормы);
	...
	Форма[ИмяРеквизитаОписанияТаблицФормы] = Новый ФиксированноеСоответствие(СоответствиеТаблиц);
