...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Если ПроведениеСерверПТБ.РучнаяКорректировкаОбработкаПроведения(ЭтотОбъект, Отказ) Тогда
		Возврат;
	КонецЕсли;
...
Процедура ОбработкаУдаленияПроведения(Отказ)
	...
	// тонкая настройка удаления записей в регистрах
	ЭтотОбъект.ДополнительныеСвойства.Вставить("ВыборочноОчищатьРегистры", Ложь);
	ЭтотОбъект.ДополнительныеСвойства.Вставить("СписокРегистровДляОчистки", Новый Массив);
	
	ПроведениеСерверПТБ.УдалитьДвиженияРегистратора(ЭтотОбъект, Отказ);
